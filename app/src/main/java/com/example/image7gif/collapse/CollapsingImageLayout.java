package com.example.image7gif.collapse;
...
//                    offsetHelper.setLeftAndRightOffset(leftOffset);
                ...
                if (child.getId() == R.id.linearlayoutFollower) {
                ...
                if (child.getId() == R.id.linearlayoutFollowing) {
                ...
                if (child.getId() == R.id.linearlayoutPost) {
